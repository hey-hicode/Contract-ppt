...
export default function UpgradeCard() {
  ...
  return (
    <div className="w-full max-w-xl p-10 bg-white/90 border border-gray-200/50 rounded-xl shadow-[.5] relative overflow-hidden backdrop-blur-xl text-center md:mx-4">
      {/* Decorative elements */}
      ...
      <div className="relative z-10 py-10">
        <h2 className="text-xl md:text-3xl font-semibold text-gray-900 mb-4 tracking-tight">
          Unlock AI Legal Analyst 🔒
        </h2>

        <p className="text-gray-600 mb-10 text-sm md:text-base leading-relaxed max-w-sm mx-auto font-medium">
