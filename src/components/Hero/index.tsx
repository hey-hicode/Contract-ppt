    ...
    <>
      ...
      >
              ...
              >
                ...
                >
                  <SignedOut>
                    ...
                    >
                      <button className="rounded-md bg-primary px-8 py-3 text-base font-semibold text-white hover:bg-primary/80 transition">
                        Start analysis
                      </button>
                    </SignInButton>
                  </SignedOut>
                  ...
                  <SignedIn>
                    <Link
                      ...
                      className="rounded-md bg-primary px-8 py-3 text-base font-semibold text-white hover:bg-primary/80 transition"
                    >
                      Start analysis
                    </Link>
                  </SignedIn>
        ...
        <motion.div
          ...
          className="relative mx-auto mt-10 max-w-[1200px] w-full bg-white rounded-xl shadow-lg border p-4 md:absolute md:left-1/2 md:top-[600px] md:-translate-x-1/2 md:mt-0 z-10 px-4"
        >
          <div className="relative aspect-[1200/600] w-full overflow-hidden rounded-lg">
            <Image
              src="/dash1.jpeg"
              fill
