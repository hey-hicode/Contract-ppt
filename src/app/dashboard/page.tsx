      ...
      <div className="space-y-6">
        ...
        <div className="px-3 sm:px-6 space-y-8 py-6 -mt-15 md:-mt-26 sm:py-8">
          <div className="grid gap-6 lg:grid-cols-[1.2fr_1.8fr]">
            ...
            <StaggerItem>
              <Card className="flex flex-col h-full justify-between border shadow-none border-[#E5E5E5] bg-white rounded-lg p-6">
                <div>
            ...
            <div className="grid md:gap-6 gap-3 grid-cols-2">
              {/* Risk Score */}
              <StaggerItem>
                <Card className=" h-full border shadow-none border-[#E5E5E5] bg-white rounded-lg p-3 md:p-6">
              ...
              {/* Red Flags */}
              <StaggerItem>
                <Card className="border h-full border-[#E5E5E5] shadow-none bg-white rounded-lg p-3 md:p-6">
